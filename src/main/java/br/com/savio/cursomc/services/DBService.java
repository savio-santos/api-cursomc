...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
	   ...
	   p11.getCategorias().addAll(Arrays.asList(cat7));
		...
		Cliente cli1 = new Cliente(null, "Sávio Santos", "saviosantos276@gmail.com", "36378912377", TipoCliente.PESSOAFISICA);
		...
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2,sdf.parse("20/10/2017 00:00"),sdf.parse("25/10/2017 00:00"));
